...
def login_page(request: Request):
    """Login page"""
    return templates.TemplateResponse("owa/login.html", {"request": request})

@router.get("/register", response_class=HTMLResponse)
def register_page(request: Request):
    """Register page"""
    return templates.TemplateResponse("owa/register.html", {"request": request})
...
async def web_login(request: Request, db: Session = Depends(get_db)):
    ...
    if not user:
        return templates.TemplateResponse("owa/login.html", {
            "request": request,
...
async def web_register(request: Request, db: Session = Depends(get_db)):
    ...
    try:
        ...
        if db_user:
            return templates.TemplateResponse("owa/register.html", {
                "request": request,
