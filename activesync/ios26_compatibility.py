...
def get_ios26_options_headers() -> dict:
    ...
    return {
        ...
        "X-MS-PolicyKey": "0",  # Will be set after provisioning
...
def get_ios26_response_headers(policy_key: str = None, protocol_version: str = None) -> dict:
    """
    ...
    if protocol_version and protocol_version in ["12.1", "14.0", "14.1", "16.0", "16.1"]:
...
def get_ios26_sync_headers(policy_key: str = None, protocol_version: str = None) -> dict:
    """
...
def get_ios26_ping_headers(policy_key: str = None, protocol_version: str = None) -> dict:
    """
...
def get_ios26_enhanced_commands() -> list:
    ...
    """
    return [
        "Sync", "FolderSync", "FolderCreate", "FolderDelete", "FolderUpdate",
        "GetItemEstimate", "Ping", "Provision", "Options", "Settings",
        "ItemOperations", "SendMail", "SmartForward", "SmartReply",
        "MoveItems", "MeetingResponse", "Search", "Find", "GetAttachment",
        "Calendar", "ResolveRecipients", "ValidateCert", "Autodiscover",
        "GetHierarchy", "SyncMail", "SyncCalendar", "SyncContacts",
        "SyncTasks", "SyncNotes", "GetItemEstimate", "ItemOperations"
    ]


def create_ios26_compatibility_headers(user_agent: str, policy_key: str = None, protocol_version: str = None) -> dict:
    """
